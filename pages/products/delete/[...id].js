import Product from "@/pages/components/ServiceAgent";
...
export default function EditProduct() {
  ...
  useEffect(() => {
    ...
    axios.get('/api/serviceAgents?id=' + id).then(response => {
  ...
  async function deleteProduct() {
    await axios.delete('/api/serviceAgents?id=' +id);
        ...
        <div class="relative p-5">
          <div class="text-center">
            ...
            <div>
              ...
              <div class="mt-2 text-sm text-secondary-500">Are you sure you want to delete this service agent? This action cannot be undone.</div>
            </div>
          </div>
